<template>
  <div>
    ...
    <el-table border
      ...
      <el-table-column prop="toCode"
                       label="跳转权限值" />

      <el-table-column label="操作">
        <template slot-scope="{row}">

          <HintButton :disabled="row.level===4"
                      type="primary"
                      icon="el-icon-plus"
                      size="mini"
          ...
          <HintButton :disabled="row.level===1"
                      type="danger"
                      icon="el-icon-delete"
                      size="mini"
    ...
    <el-dialog :visible.sync="dialogPermissionVisible"
      ...
      <el-form ref="permission"
        ...
        <el-form-item label="父级名称"
          ...
          <el-input :value="permission.pname"
                    disabled />
        </el-form-item>
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   @click="addOrUpdatePermission">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
